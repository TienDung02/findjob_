        ...
        <form class="form_add_company" method="post" action="" style="width: 70%">
                ...
                <div class="parentContainer w-100 form">
                    ...
                    <div class="controlContainer">
                        <div class="inputFileHolder">
                            ...
                            <input id="fileInput2" name="fileInput2" class="fileInput" title="Choose file to upload"
                                   type="file" accept=".txt">
                        </div>
                        <div class="inputFileMask">
                            <input class="inputFileMaskText2" readonly="readonly" placeholder="Choose file.."
                                   type="text" id="inputFileMaskText2">
                        </div>
                    </div>
                </div>
            ...
            <div class="parentContainer w-80 form">
                ...
                <div class="controlContainer">
                    ...
                    <div class="inputFileMask">
                        <input class="inputFileMaskText2" readonly="readonly" placeholder="Choose file.." type="text"
                               id="inputFileMaskText2">
                    </div>
                </div>
            </div>
