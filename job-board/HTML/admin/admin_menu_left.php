...
<aside class="  menu_01 d-block">
    <div class="menu_left  ">
        <ul>
            ...
            <li class="<?php if ($file_name == 'admin_job_page.php' || $file_name == 'admin_view_job.php'){ echo 'active';} ?>">
    ...
    <div class="menu_left  ">
        <ul>
            <li class="btn_Show_menu">
                <a id="show_menu" href="#" style="font-size: 3rem !important;">></a>
            </li>
            <li class="<?php if ($file_name == ''){ echo 'active';} ?>">
            ...
            <li class="<?php if ($file_name == 'admin_blog_page.php'|| $file_name == 'admin_add_blog.php' || $file_name == 'admin_view_blog.php'){ echo 'active';} ?>">
                <a href="../blog/admin_blog_page.php"><i class="bi bi-pen"></i></a>
            </li>
        </ul>
    </div>
</aside>