    ...
    <main>
        ...
        <div class="contain">
            ...
            <div class="table-main">
                ...
                $start = ($page - 1) * $limit;
                $sql_select_all = "SELECT job.*,employer.* FROM job JOIN employer ON job.id_employer=employer.id_employer limit $start,$limit";
                $show_jobs = callsql($sql_select_all);
                ?>
                <table class="table table-hover">
                    ...
                    <?php $n = 1;
                    $x = 1;
                    if (count($show_jobs) < 2) {
                        $x = 0;
                    }
                    foreach ($show_jobs as $job) {
                        ?>
                        <tr>
                            <td>
                            ...
                            <td>
                                <?php echo $job['first_name'] . ' ' . $job['last_name']; ?>
                            </td>
                            <td>
                                <?php echo $job['title'] ?>
                            </td>
                            <td>
                                <input class="toggle_switch" <?php if ($job['active'] == 1){echo 'checked';} ?> " type="checkbox">
                            </td>
                            <td>
                                <a
                                        href="<?php echo "admin_view_job.php?id={$job['id']}"; ?>"><i
