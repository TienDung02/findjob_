...
<div class="d-flex">
    <?php require_once('menu_left_employer.php') ?>
    ...
    <div class="contain" style="margin: auto; width: calc(100% - 260px);background-color: #f7f7f7">
        ...
        <form class="form_add_company" method="post" action="" style="width: 90%">
            ...
            <div class="d-flex form optional flex-wrap ">
                ...
                <div class="form">
                    ...
                    <select class="form-select form-select-lg mb-3" style="height: 57px;color: #909090;" aria-label=".form-select-lg example">
                ...
                <div class="form">
                    ...
                    <select class="form-select form-select-lg mb-3" style="height: 57px;color: #909090;" aria-label=".form-select-lg example">
                        <option selected>-</option>
                        <option value="01 - 05">$15 - $20k</option>
                        <option value="05 - 15">$20 - $30k</option>
                        <option value="15 - 30<">$30 - $40k</option>
                        <option value="30 - 50">$40 - $50k</option>
                        <option value="50+">$50+</option>
                    </select>
                </div>
